<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="content">
                <p class="title_name">Mosaic pictures and panels</p>
                <div class="gallery_container">
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        if (($row['id'] == '47') or ($row['id'] == '48') or ($row['id'] == '49')) {
                            ?> 
                            <a href="/eng/artwork.php?id=6"><img class="gallery_img_triptych" src=<?php include($_SERVER['DOCUMENT_ROOT'] . '/connect_img.php') ?><?php echo $row['img1'] ?>></a>
                            <?php
                        }
                    }
                    ?>
