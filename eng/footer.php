<div class="footer">
    ...
    <ul class="footer_menu">
        ...
        <li><a href="/eng/aboutme.php">About</a></li>
        <li><a href="/eng/portfolio.php">Portfolio</a></li>
        <li><a href="/eng/contacts.php">Contact</a></li>
        <li><a href="/eng/exhibitions.php">Exhibitions</a></li>
        <li><a href="/eng/pricelist.php">Price list</a></li>
    </ul>
    ...
    <p class="footer_logo">Elena Kirillova ©</p>
    <p class="footer_created">The site is created by Alena Tsemkalo</p>
</div>